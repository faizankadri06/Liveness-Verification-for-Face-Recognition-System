...
def video_feed(request):
    ...
    return StreamingHttpResponse(recognition_liveness(), content_type='multipart/x-mixed-replace; boundary=frame')
#
# if __name__ == '__main__':
#     name, label_name = recognition_liveness('liveness.model', 'label_encoder.pickle',
#                                             'face_detector', 'encoded_faces.pickle', confidence=0.9)
